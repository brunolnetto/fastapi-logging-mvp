...
def get_table_size(session: Session, table_name: str, schema_name: str = 'public') -> dict:
    """
    ...
    result = session.execute(query, {'schema_name': schema_name, 'table_name': table_name}).fetchone()
